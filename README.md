...
| ----------- | ----------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `formSpecs` | [`FormField[]`](#formfield) \| `(props:`[`FormSpecProps`](#formspecprops)`)` => [`FormField[]`](#formfield) | **Required** | Form schema to populate UI and corresponding states.<br>`(props: [FormSpecProps](#formspecprops)) => FormField[]` is used to utilize inbuilt form functions and validate using associated fields. |
